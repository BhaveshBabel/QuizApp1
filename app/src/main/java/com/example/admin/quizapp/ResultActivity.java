...
import com.example.admin.quizapp.Adapter.ResultGridAdapter;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_filter_no_answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < Common.answerSheetListFiltered.size(); i++)
                {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case android.R.id.home :
                ...
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);    // clear all activity
    ...
    private void doQuizAgain() {
        new MaterialStyledDialog.Builder(ResultActivity.this)
                ...
                .setDescription("Do you really want to delete the data ?")
                .setNegativeText("No")
